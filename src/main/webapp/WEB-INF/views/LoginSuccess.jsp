	...
	<div class="container">
		<div id="content1">
			<div id="wrap1">
				...
				<p id="one">빠르고 쉽게 진료예약을 <br> 하실 수 있습니다.</p><br>
				<div id="rv">
					<ul id="rv1">
						<li><a href="reservation.jsp" role="button">진료예약</a></li>
						<li><a href="rvlist.jsp" role="button">예약확인</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div id="content2">
			<div id="wrap2">
				...
				<p id="two">병원의 진료과 / 센터를<br>상세히 확인할 수 있습니다.</p><br>
				<div id="rv">
					<ul id="rv2">
		...
		<div id="content3">
			<div id="wrap3">
				...
				<p id="three">대표전화 <strong id="tel1">1588-5700</strong></p>
				<p id="three1">암환자 상담 <strong id="tel2">02-2072-0707</strong><br><Br>
				<div id="rv">
					<ul id="rv3">
		...
		<div id="content4">
			<div id="wrap4">
				...
				<div id="rv">
				<ul id="rv4">
						<li><a href="rvlist.html" role="button">예약확인/취소</a></li>
